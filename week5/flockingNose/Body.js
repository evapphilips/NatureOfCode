...
class Body{
    ...
    // flee applies a steering force away from a target
    flee(target){
        // A vector pointing from the location to the target
        let desired = p5.Vector.sub(target, this.position)
        // get distance between mouse and body
